...
def create_png(input_filename, output_filename_w, output_filename_s, image_width, image_height, fft_size, f_max, f_min, wavefile, palette):
...
if __name__ == '__main__':
    ...
    if not options.version:
	    ...
	    for input_file in args:
	        ...
	        args = (input_file, output_file_w, output_file_s, options.image_width, options.image_height, options.fft_size, options.f_max, options.f_min, options.wavefile, options.palette)
